...
export default function Navbar() {
  ...
  const mobileLinks = [
    ...
    { href: '/yeni-projeler', label: 'Yeni Projeler', authRequired: false },
    ...
    { href: '/fiyat-trendi', label: 'Fiyat Trendi', authRequired: false },
    ...
    { href: '/odeme-plani', label: 'Ödeme Planı Simülatörü', authRequired: false },
    { href: '/kira-mi-satin-mi', label: 'Kira mı Satın mı?', authRequired: false },
    { href: '/pesinat-plani', label: 'Peşinat Birikim Planı', authRequired: false },
    { href: '/kira-geliri-vergisi', label: 'Kira Geliri Vergisi', authRequired: false },
    { href: '/kredi-karsilastirma', label: 'Kredi Karşılaştırma', authRequired: false },
            ...
            {toolsOpen && (
              <div className="absolute left-0 top-full mt-2 w-56 bg-white shadow-xl rounded-2xl border border-gray-100 py-2 z-50">
                {[
                  ...
                  { href: '/pesinat-plani', label: 'Peşinat Planı' },
