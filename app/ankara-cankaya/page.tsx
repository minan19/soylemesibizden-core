  ...
  try {
    return await prisma.listing.findMany({
      where: {
        ...
        district: { contains: 'Çankaya', mode: 'insensitive' },
      },
    ...
    <main className="min-h-screen bg-[#F8FAFC]">
      <section className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
        <div className="max-w-4xl mx-auto px-6 py-14">
          ...
          <div className="flex gap-3 mt-6">
            ...
            <Link href="/listings?city=Ankara&district=Çankaya&listingType=KİRALIK" className="border border-white/30 text-white text-xs font-black px-5 py-2.5 rounded-full hover:bg-white/10 transition-colors">
              Kiralık İlanlar
            </Link>
          </div>
        </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-10 space-y-10">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
          <h2 className="text-base font-black text-gray-900 mb-4">Çankaya Piyasa Özeti</h2>
        ...
        {ilanlar.length > 0 && (
          <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
            <h2 className="text-base font-black text-gray-900 mb-4">Güncel Çankaya İlanları</h2>
