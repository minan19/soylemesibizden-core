...
const CATEGORIES: Category[] = [
  {
    ...
    tools: [
      ...
      { href: '/dolar-kuru-etkisi', icon: TrendingUp, label: 'Döviz Kuru Etkisi', desc: 'USD/EUR bazlı değer, kur senaryo analizi', badge: 'Yeni' },
  ...
  },
  {
    ...
    tools: [
      ...
      { href: '/yatirim-getiri-simulatoru', icon: TrendingUp, label: 'Yatırım Getiri Simülatörü', desc: 'Kira + değer artışı + satış toplam ROI', badge: 'Yeni' },
  ...
  },
  {
    ...
    tools: [
      ...
      { href: '/piyasa-raporu-2024', icon: BarChart2, label: 'Piyasa Raporu 2024', desc: 'Yıllık satış, fiyat, getiri verileri', badge: 'Yeni' },
    ],
  },
  {
